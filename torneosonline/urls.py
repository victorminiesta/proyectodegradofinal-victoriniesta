...
urlpatterns = [
    ...
    path('administracion/partidas', AdministrarPartidas.as_view(), name="AdministrarPartidas"),
    path('administracion/partidas/editar/<int:pk>', EditarPartida.as_view(), name="EditarPartida"),
    path('administracion/partidas/eliminar/<int:pk>', EliminarPartida, name="EliminarPartida"),
    ...
    path("torneos/crearPartida/<int:pk>", crearPartida, name="crearPartida"),
]